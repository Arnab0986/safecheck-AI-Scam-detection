...
const Navbar = () => {
  ...
  /** Memoized nav items (avoid recalculating on every render) */
  ...
  const NavItem = ({ item, onClick }) => (
    <Link
      to={item.path}
      onClick={onClick}
      className="flex items-center space-x-2 px-4 py-2 text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition duration-200"
    >
      {item.icon}
